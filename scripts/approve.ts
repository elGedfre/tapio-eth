...
async function main() {
  ...
  const cbETHSwap = await StableSwap.attach(
    "0x6a589DA7D666A903fBf2c78CBd7D38D378edE593",
  );
  let txn1 = await cbETHSwap.approve(
    wETHAddress,
    "0x3Ea5a52a985091F37555F842A164BE66eCDF1AD1",
  );
  console.log(txn1.hash);
  let txn2 = await cbETHSwap.approve(
    "0xd994DD0FA5D62306BC2E46B96104E7Fda80Afa62",
    "0x3Ea5a52a985091F37555F842A164BE66eCDF1AD1",
  );

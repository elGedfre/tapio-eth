...
async function main() {
  ...
  const exchangeRateProviderAddress =
    "0x9C3aF1d0b2590d4143AEafF23eF23E6B533fC7c5";
  ...
  const rETHSwap = await upgrades.deployProxy(StableAsset, [
